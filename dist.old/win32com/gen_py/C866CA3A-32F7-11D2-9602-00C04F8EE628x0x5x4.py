...
# By python version 2.7.16 (v2.7.16:413a49145e, Mar  4 2019, 01:30:55) [MSC v.1500 32 bit (Intel)]
# From type library '{C866CA3A-32F7-11D2-9602-00C04F8EE628}'
# On Sat May 25 15:18:14 2019
...
ISpMMSysAudio_vtables_ = [
	(( u'GetDeviceId' , u'puDeviceId' , ), 1610940416, (1610940416, (), [ (16403, 2, None, None) , ], 1 , 1 , 4 , 0 , 104 , (3, 0, None, None) , 0 , )),
	(( u'SetDeviceId' , u'uDeviceId' , ), 1610940417, (1610940417, (), [ (19, 1, None, None) , ], 1 , 1 , 4 , 0 , 108 , (3, 0, None, None) , 0 , )),
	(( u'GetMMHandle' , u'pHandle' , ), 1610940418, (1610940418, (), [ (16408, 2, None, None) , ], 1 , 1 , 4 , 0 , 112 , (3, 0, None, None) , 0 , )),
	(( u'GetLineId' , u'puLineId' , ), 1610940419, (1610940419, (), [ (16403, 2, None, None) , ], 1 , 1 , 4 , 0 , 116 , (3, 0, None, None) , 0 , )),
	(( u'SetLineId' , u'uLineId' , ), 1610940420, (1610940420, (), [ (19, 1, None, None) , ], 1 , 1 , 4 , 0 , 120 , (3, 0, None, None) , 0 , )),
]
