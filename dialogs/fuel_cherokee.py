...
class fuel(wx.Panel, baseDialog.BaseWXDialog):
 def __init__(self, parent):
  ...
  wl_label = wx.StaticText(self, wx.ID_ANY, "left wing tank: ")
  ...
  wr_box.Add(wx.StaticText(self, -1, "Right wing tank: "), 0, wx.ALL, 5)
  ...
  ttl_box.Add(wx.StaticText(self, -1, "Left Tip Tank: "), 0, wx.ALL, 5)
  ...
  ttr_box.Add(wx.StaticText(self, -1, "Right Tip Tank: "), 0, wx.ALL, 5)
  self.tip_right = wx.TextCtrl(self, -1)
  ttr_box.Add(self.tip_left, 0, wx.ALL, 5)
  sizer.Add(ttl_box, 0, wx.ALL, 5)
