...
class fuel(wx.Panel, baseDialog.BaseWXDialog):
 def __init__(self, parent):
  ...
  wl_label = wx.StaticText(self, wx.ID_ANY, "left wing tank in gallons (max 25): ")
  ...
  wr_box.Add(wx.StaticText(self, -1, "Right wing tank in gallons (max 25): "), 0, wx.ALL, 5)
  ...
  oil_box.Add(wx.StaticText(self, -1, "Oil quantity in gallons (max 2): "), 0, wx.ALL, 5)
