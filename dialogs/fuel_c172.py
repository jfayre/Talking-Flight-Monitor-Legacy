...
class fuel(wx.Panel, baseDialog.BaseWXDialog):
    def __init__(self, parent):
        ...
        wl_label = wx.StaticText(self, wx.ID_ANY, "left wing tank in gallons (max 28): ")
        ...
        wr_box.Add(wx.StaticText(self, -1, "Right wing tank in gallons (max 28): "), 0, wx.ALL, 5)
...
class fuelDialog(baseDialog.BaseWXDialog):
    ...
    def __init__(self):
        ...
        self.SetTitle("A2A C172 Fuel manager")
