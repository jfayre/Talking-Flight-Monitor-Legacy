...
import config
import application
from dialogs import fuel_bonanza, fuel_cherokee, fuel_c172, fuel_c182
...
class fuelControllerCherokee(object):
    ...
    def create_fuel(self):
        ...
        self.dialog.realize()
        self.response = self.dialog.get_response()
class fuelControllerC172(object):
    # controller for A2A C172
    def __init__(self):
        super(fuelControllerC172, self).__init__()
        self.dialog = fuel_c172.fuelDialog()
        self.create_fuel()
